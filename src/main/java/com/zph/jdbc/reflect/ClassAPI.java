...
public class ClassAPI {
    public static void main(String[] args) throws Exception {
        Class<?> clazz = Class.forName("com.zph.jdbc.reflect.Student");
        //获取成员变量,包括子类及父类，同时只能包含公共的变量
        ...
        //此方法返回的是[当前类]的所有属性，不仅仅局限于公共访问修饰符，所有的访问修饰符都可以拿到
        ...
        Student o2 = (Student) declaredConstructor.newInstance("messi", 23, "football");
