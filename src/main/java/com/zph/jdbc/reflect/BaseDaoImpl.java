...
import com.zph.jdbc.entity.Dept;
...
public class BaseDaoImpl {
    ...
    public List getRows(String sql, Object[] params, Class clazz) {
        ...
        try {
            ...
            OracleDBUtil.closeConnection(connection, pstmt, resultSet);
        }
    ...
    public static void main(String[] args) {
        ...
        List rows1 = baseDao.getRows("select empno,ename,sal,deptno from emp where deptno =?", new Object[]{10}, Emp.class);
        for(Iterator it = rows1.iterator();it.hasNext();){
            Emp emp = (Emp) it.next();
            System.out.println(emp);
        }
        System.out.println("---------------------------------");
        List rows2 = baseDao.getRows("select deptno,dname,loc from dept", new Object[]{}, Dept.class);
