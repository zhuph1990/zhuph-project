...
public class Z5_OperatorDemo {
    ...
    public static void main(String[] args) {
		...
		*/
        ...
        // 十进制转换为二进制
        String numberFour = Integer.toBinaryString(4); //100
        System.out.println(numberFour);
        int four = Integer.parseInt("100");  //当然s只能是数字类的字符串
        System.out.println(four);
        String z = Integer.toBinaryString(5); //101
        System.out.println(z);

        System.out.println(4 & 5); //有0就是0，全为1才是1  -->100--> 4
        System.out.println(4 | 5); //有1就是1，全为0才是0  -->101-->5
        System.out.println(4 ^ 5); //相异为1，相同为0      -->001-->1
        int k = Integer.valueOf("100", 2);
