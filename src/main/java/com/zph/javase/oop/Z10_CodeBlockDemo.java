 ...
 * */
public class Z10_CodeBlockDemo {
    ...
    public Z10_CodeBlockDemo() {
        System.out.println("无参");
        System.out.println("构造方法");
    }

    public Z10_CodeBlockDemo(int a) {
        this.a = a;
    }

    public Z10_CodeBlockDemo(int a, int b) {
        this(a);
        this.b = b;
    }
    ...
    public static void main(String[] args) {
        Z10_CodeBlockDemo codeBlockDemo = new Z10_CodeBlockDemo(1, 2);
        codeBlockDemo.test();
        {
