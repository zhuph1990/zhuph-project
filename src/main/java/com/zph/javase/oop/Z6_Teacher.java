...
public class Z6_Teacher {
    ...
    public Z6_Teacher(String xname) {
        System.out.println("one argument");
        name = xname;
    }

    //构造方法
    public Z6_Teacher(String xname, int xage) {
